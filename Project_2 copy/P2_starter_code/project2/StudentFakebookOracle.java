        ...
        try (Statement stmt = oracle.createStatement(FakebookOracleConstants.AllScroll, FakebookOracleConstants.ReadOnly)) {
            ...
            */
            ...
            while(rst.next()){
                ...
                try(Statement stmt1 = oracle.createStatement(FakebookOracleConstants.AllScroll, FakebookOracleConstants.ReadOnly)){
                    ...
                    UserInfo u1 = new UserInfo(rst1.getLong(1),rst1.getString(3),rst1.getString(4));
                    UserInfo u2 = new UserInfo(rst1.getLong(2),rst1.getString(5),rst1.getString(6));
                    MatchPair mp = new MatchPair(u1,rst1.getInt(7),u2,rst1.getInt(8));
                        System.out.println("Line 445");
                //  PhotoInfo(long pID, long aID, String link, String albName)
